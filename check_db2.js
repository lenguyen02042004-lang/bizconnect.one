const url =
  "https://umvwsgrpsjqxurehqjbs.supabase.co/rest/v1/businesses?select=id,name,slug,country_code,province,logo_url,short_intro,email,phone,website,owner_id,status,industry_id";
const apikey =
